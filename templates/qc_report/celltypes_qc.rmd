...
knitr::asis_output(
  print("This section details cell type annotations provided by the original lab ('submitter') which generated this data.")
)
```
...
knitr::asis_output(
  glue::glue(
  "* Cell type annotations were also provided by the original lab ('submitter') which generated this data.
  * In these cell type annotations, the label 'Unclassified cell' indicates that submitters did not provide an annotation for the given cell. 
  "
  )
)
```
