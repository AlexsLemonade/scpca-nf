...
```
nextflow run AlexsLemonade/scpca-nf -r v0.9.1 -profile ccdl_staging,batch --project SCPCP000000
```
...
```
nextflow run AlexsLemonade/scpca-nf -r v0.9.1 -profile ccdl_prod,batch --project SCPCP000000
```
