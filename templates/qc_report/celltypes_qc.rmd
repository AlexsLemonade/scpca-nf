...
Colors represent whether the probabilities correspond to a cell with that given annotation: Yellow distribution represent probabilies for cells that _were_ annotated as the given cell type.
