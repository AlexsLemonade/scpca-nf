...
workflow {
  ...
  unfiltered_runs_ch = Channel.fromPath(params.run_metafile)
    ...
    [
      ...
      ref_fasta: file("${params.ref_rootdir}/${sample_refs["ref_fasta"]}"),
      ref_gtf: file("${params.ref_rootdir}/${sample_refs["ref_gtf"]}"),
      salmon_splici_index: file("${params.ref_rootdir}/${sample_refs["splici_index"]}"),
      t2g_3col_path: file("${params.ref_rootdir}/${sample_refs["t2g_3col_path"]}"),
      salmon_bulk_index: file("${params.ref_rootdir}/${sample_refs["salmon_bulk_index"]}"),
      t2g_bulk_path: file("${params.ref_rootdir}/${sample_refs["t2g_bulk_path"]}"),
      cellranger_index: file("${params.ref_rootdir}/${sample_refs["cellranger_index"]}"),
      star_index: file("${params.ref_rootdir}/${sample_refs["star_index"]}"),
