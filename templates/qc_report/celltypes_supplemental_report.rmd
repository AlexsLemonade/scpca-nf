...
- Cell types with less than 3 labeled cells are not shown in the plot.
")
```
...
delta_median_df <- delta_median_df |>
  ...
  # don't plot celltypes with < 3 cells
  dplyr::filter(annotation_wrapped != "Other")
...
Cells to the right of the dashed line are those for which the model is less confident in the prediction.
