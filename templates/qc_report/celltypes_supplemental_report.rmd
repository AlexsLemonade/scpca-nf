...
# add count and alpha indicator
celltype_df <- celltype_df |>
  dplyr::add_count(cellassign_celltype_annotation) |>
  dplyr::mutate(
    # if more cells, less opaque
    alpha = ifelse(n <= 100, 1, 0.7)
  )

# make a small celltype_df for bigger rugs where needed
celltype_df_small <- celltype_df |>
  dplyr::filter(n < 2)
...
ggplot(celltype_df) + 
  ...
  # bigger rug for n<3 rows
  geom_segment(
    data = celltype_df_small, 
    aes(
      x = cellassign_max_prediction, 
