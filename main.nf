...
celltype_report_template_tuple = tuple(report_template_dir, celltype_report_template_file) // only used if cell typing is present/performed
...
workflow {
 ...
 runs_ch = unfiltered_runs_ch
  ...
  sce_qc_report(
    ...
    celltype_report_template_tuple
  )
