...
`CellAssign` annotates cells by selecting the cell type with the highest probability among all cell types considered. 

The plot below shows probability distributions of all cells assigned to each cell type.
Blue line segments shown as a 'rug' represent individual cell probabilities that comprise each distribution.
