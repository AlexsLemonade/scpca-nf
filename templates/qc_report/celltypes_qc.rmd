...
Colors represent whether the probabilities correspond to a cell with that given annotation: Yellow distributions represent probabilies for cells that _were_ annotated as the given cell type.
Purple distributions represent probabilities for cells that _were not_ annotated as the given cell type.
