...
```{r methods-info-box, eval = !is_supplemental, results = "asis"}
```
...
glue::glue("
  For additional information about cell typing, including details on reference sources, comparisons among cell type annotation methods, and diagnostic plots, please refer to the [supplementary cell type QC report](`r params$celltype_report`).
 ")
```
