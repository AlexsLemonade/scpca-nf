...
params:
  library: Example
  processed_sce: NULL
  validation_groups_file: NULL
  validation_markers_file: NULL
  validation_palette_file: NULL
  date: !r Sys.Date()
...
if (has_consensus) {
  stopifnot(
    "Consensus cell types are present but the validation_groups_file does not exist" = file.exists(params$validation_groups_file),
    "Consensus cell types are present but the validation_markers_file does not exist" = file.exists(params$validation_markers_file),
    "Consensus cell types are present but the validation_palette_file does not exist" = file.exists(params$validation_palette_file)
  )
}
...
# only show cell type heatmap section if submitter + at least one other celltype or consensus is present
glue::glue(
  "
