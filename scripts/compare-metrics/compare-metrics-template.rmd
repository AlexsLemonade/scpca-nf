...
if (!has_cluster_changes) {
  ...
  knitr::asis_output(glue::glue_data(
    ...
    which corresonds to a mean percentage change of **{round(mean_cluster_number_change_frac * 100, digits = 2)}%**.
    ...
    Note that this only includes comparisons that have the same number of cells between the two runs.
    "
  ))
}
```
