...
In the plot below, we show distributions of the `CellAssign` probabilities for each assigned cell type.
...
```{r, eval = has_cellassign, warning=FALSE, message=FALSE, fig.height = 6, fig.width = 8}
