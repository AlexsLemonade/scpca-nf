...
As an example, the [Dockerfile that we used to build Cell Ranger](docker/cellranger/Dockerfile) can be found in the `docker/cellranger` directory of this repo.
