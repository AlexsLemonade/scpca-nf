...
<!-- TODO: Make this dependent on if consensus cell types exist --> 
## Expression of marker genes in consensus cell types

This section looks at expression of a set of marker genes for each normal cell type across all cells. 
