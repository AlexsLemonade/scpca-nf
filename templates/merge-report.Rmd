...
if (multiplexed) {
  ...
  glue::glue("
    ...
    Demultiplexing has not been performed, so sample statistics will not be displayed.
...
The following table shows the total number of samples associated with each diagnoses.
