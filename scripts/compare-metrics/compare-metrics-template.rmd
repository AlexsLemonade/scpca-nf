...
if (!has_cluster_changes) {
  ...
  knitr::asis_output(glue::glue_data(
    ...
    Among the libraries with changes, the mean change in the number of clusters is **{mean_n_change}**, which corresonds to a mean percentage change of **{round(mean_n_change_frac * 100, digits = 2)}%**.
