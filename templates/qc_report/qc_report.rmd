...
# for celltypes, we expect these four columns. 
# TODO: do we need to check for all 4?
celltype_cols <- c("singler_celltype_ontology",
                   "singler_celltype_annotation",
                   "cellassign_celltype_annotation",
                   "cellassign_max_prediction")
if (has_processed) {
  has_umap <- "UMAP" %in% reducedDimNames(processed_sce)
  has_celltypes <- all(celltype_cols %in% names(colData(processed_sce)))
