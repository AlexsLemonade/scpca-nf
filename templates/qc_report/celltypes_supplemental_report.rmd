...
# This variable whether to print sentence "please refer to supp report", 
# as called from `celltypes_qc.rmd` child report. 
# We do not print this sentence in the supplemental report.
...
- How do submitter-provided cell type annotations, if available, compare to results from automated cell type annotation methods based on reference data or marker genes?
- How reliable are these automated annotation methods?
...
One way to address this is to perform multiple cell type annotation approaches and compare the results, which is what we have done here.
When multiple methods annotate a given cell as the same or similar cell type, this may indicate that the annotation is more reliable.
...
This report first recapitulates the cell type section from the main QC report and then performs further comparisons across cell type annotations.
