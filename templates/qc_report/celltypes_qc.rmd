...
The folllowing reference dataset, obtained from the [`celldex` package](http://bioconductor.org/packages/release/data/experiment/html/celldex.html) package, was used:
")
metadata(processed_sce)$singler_reference # TODO: format??
```
