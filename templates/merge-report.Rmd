...
That is because the UMAPs presented here have been weighted so that each library contributes equally to the overall scaling.
...
# 1 inch per UMAP row
umap_height <- ceiling(n_libraries / facet_ncol)
